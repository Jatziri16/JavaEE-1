...
{
	public abstract void insertar(Videojuego videojuego);
	public abstract List<Videojuego> buscarTodos();
	public abstract Videojuego seleccionar(Integer cve);
	public abstract List<Videojuego> filtrarPorProv(int cveprov);
	public abstract void guardarCambios(Videojuego videojuego);
	public abstract void borrar(Videojuego videojuego);
	
	
	/*public abstract void insertar(String titulo, float precio, int cveprov, int inventario) throws DataBaseException;
	public abstract List<Videojuego> buscarTodos();
	public abstract Videojuego getVideojuego(int cve);
	public abstract List<Videojuego> filtrarVideojuegosProv(int cveprov);
	public abstract void actualizarVideojuego(int cve, String titulo, float precio, int cveprov, int inventario);
	public abstract boolean borrarVideojuego(int cve);*/
